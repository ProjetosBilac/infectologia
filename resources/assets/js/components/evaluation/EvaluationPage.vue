<template>
  <form class="l-evaluation__main" :action="route" method="POST" @submit="enviaResposta">
    <div class="l-evaluation__wrapper">
      ...
      <aside class="l-evaluation__aside">
        <div class="c-box">
          <article class="c-page-evaluation c-box__body">
            ...
            <div class="c-page-evaluation__submit-container">
...
export default {
  ...
  mounted () {
    this.data.inputs.forEach((questao, index) => {
      ...
      questao.options = questao.options.sort(() => Math.random() - 0.5)
